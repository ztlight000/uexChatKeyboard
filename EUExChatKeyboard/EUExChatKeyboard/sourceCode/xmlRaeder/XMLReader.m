...
NSString *const kInputXMLReaderTextNodeKey		= @"text";
NSString *const kInputXMLReaderAttributePrefix	= @"@";
...
- (void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    ...
    if ([self.textInProgress length] > 0)
    {
        ...
        [dictInProgress setObject:[trimmedString mutableCopy] forKey:kInputXMLReaderTextNodeKey];
